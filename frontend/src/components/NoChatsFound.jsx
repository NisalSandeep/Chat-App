  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 text-center space-y-4">
      <div className="w-16 h-16 bg-sky-500/10 rounded-full flex items-center justify-center">
        <MessageCircleIcon className="w-8 h-8 text-sky-400" />
      </div>
      <div>
      ...
      <button
        ...
        className="px-4 py-2 text-sm text-sky-400 bg-sky-500/10 rounded-lg hover:bg-sky-500/20 transition-colors"
      >
        Find contacts
      </button>
    </div>
